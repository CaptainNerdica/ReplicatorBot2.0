...
public class Message
{
	...
	public static Message Empty { get; } = new(0, 0, MessageType.Raw, 0, "No messages found.");

	public Message(ulong guildId, ulong messageId, MessageType type, int index, string text)
	{
		GuildId = guildId;
		MessageId = messageId;
		Type = type;
